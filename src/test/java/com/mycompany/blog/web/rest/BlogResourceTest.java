...
public class BlogResourceTest {
    ...
    private static final String DEFAULT_HANDLE = "SAMPLE_TEXT";
    private static final String UPDATED_HANDLE = "UPDATED_TEXT";
    ...
    public void setup() {
        ...
        this.restBlogMockMvc = MockMvcBuilders.standaloneSetup(blogResource).setMessageConverters(jacksonMessageConverter).build();
    }
